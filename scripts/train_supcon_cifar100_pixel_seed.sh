...
# Seed-parameterized SupCon + F-Fidelity Pixel Removal training for CIFAR-100
# 10% scattered pixel removal (exact F-Fidelity implementation)
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/cifar100_r152/supcon_pixel_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"supcon_cifar100_pixel_seed${SEED}"}

echo "=========================================="
echo "CLXAI: SupCon + F-Fidelity Pixel - CIFAR-100 + ResNet-152 (Seed ${SEED})"
echo "=========================================="
...
# Run training
echo "Starting SupCon + F-Fidelity Pixel training with seed ${SEED}..."
