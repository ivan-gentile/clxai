...
# Seed-parameterized SupCon + F-Fidelity Pixel Removal (50% probability)
# 10% scattered pixel removal with coin flip
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/scl_pixel50_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"scl_supcon_pixel50_seed${SEED}"}

echo "=========================================="
echo "CLXAI: SupCon + Pixel50 Augmentation (Seed ${SEED})"
echo "=========================================="
