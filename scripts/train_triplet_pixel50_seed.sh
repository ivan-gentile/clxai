...
# Seed-parameterized Triplet + F-Fidelity Pixel Removal (50% probability)
# 10% scattered pixel removal with coin flip
# IMPORTANT: Using semi-hard mining to prevent embedding collapse
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/triplet_pixel50_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"triplet_pixel50_seed${SEED}"}

echo "=========================================="
echo "CLXAI: Triplet + Pixel50 Augmentation (Seed ${SEED})"
echo "=========================================="
