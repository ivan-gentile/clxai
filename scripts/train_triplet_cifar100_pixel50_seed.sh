...
# Seed-parameterized Triplet + F-Fidelity Pixel50 for CIFAR-100
# IMPORTANT: Using semi-hard mining to prevent embedding collapse
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/cifar100_r152/triplet_pixel50_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"triplet_cifar100_pixel50_seed${SEED}"}

echo "=========================================="
echo "CLXAI: Triplet + Pixel50 - CIFAR-100 + ResNet-152 (Seed ${SEED})"
echo "=========================================="
...
echo "Starting Triplet + Pixel50 training with seed ${SEED}..."
