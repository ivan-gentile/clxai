...
#SBATCH --gres=gpu:4
#SBATCH --mem=494000
#SBATCH --job-name=supcon_r152_noise_multi
#SBATCH --output=logs/slurm/supcon_r152_noise_multi_%j.out
#SBATCH --error=logs/slurm/supcon_r152_noise_multi_%j.err

echo "=========================================="
echo "SupCon ImageNet R152 - NOISE - Multi-Node DDP"
echo "=========================================="
...
srun python src/training/train_scl_imagenet_ddp.py \
    ...
    --run_name "supcon_r152_noise_multi_${SLURM_JOB_ID}"
